  ...
  return (
    <main className="w-full min-h-screen bg-[#0c0d0c] overflow-x-hidden">
      ...
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div 
          className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-0 animate-slow-zoom"
        ...
        {/* Contenido Central */}
        <div className="relative z-10 flex flex-col items-center text-center px-4 max-w-4xl opacity-0 animate-fade-in-up delay-100">
          <div className="mb-6 flex items-center gap-3 px-4 py-2 rounded-full border border-[#D1A65B]/30 bg-[#D1A65B]/10 backdrop-blur-md">
            ...
            <span className="text-sm font-medium text-[#D1A65B] tracking-widest uppercase">El nuevo estándar teológico</span>
          </div>
          
          <h1 className="text-5xl md:text-7xl font-serif text-[#F9F6F0] mb-6 leading-tight drop-shadow-2xl">
          ...
          <p className="text-lg md:text-xl text-[#F9F6F0]/70 mb-10 max-w-2xl font-light">
      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Tarjeta 1 */}
          <div className="bg-[#151715]/80 backdrop-blur-sm border border-[#D1A65B]/10 p-8 rounded-3xl hover:border-[#D1A65B]/40 transition-all duration-500 hover:-translate-y-2 shadow-2xl group">
      ...
      <section className="relative py-32 flex items-center justify-center overflow-hidden my-12">
        {/* Imagen fija al fondo (Parallax Effect) */}
        <div 
        ...
        ></div>
        <div className="absolute inset-0 bg-[#0c0d0c]/70 mix-blend-multiply"></div>
        
        <div className="relative z-10 text-center px-6 max-w-4xl">
          <Sparkles size={40} className="mx-auto text-[#D1A65B] mb-8 opacity-50" />
          <h2 className="text-3xl md:text-5xl font-serif text-[#F9F6F0] leading-snug italic drop-shadow-lg">
      ...
      <footer className="border-t border-[#D1A65B]/10 bg-[#050605] py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-6 text-[#F9F6F0]/60 text-sm">
